...
public class EmployeeMyApplicationsController extends EmployeeBaseController {
    ...
    public void setCurrentEmployee(Employee employee) {
        ...
        // Reload applications when employee is set
        if (employee != null) {
            loadApplications();
        }
    }
    ...
    private void loadApplications() {
        ...
        try {
            ...
            List<Application> applications = applicationService.getApplicationsByEmail(currentEmployee.getEmail());
    ...
    private void handleWithdrawApplication(Application application) {
        System.out.println(" Attempting to withdraw application: " + application.getJobTitle());
        Alert confirmAlert = new Alert(Alert.AlertType.CONFIRMATION);
        confirmAlert.setTitle("Withdraw Application");
        confirmAlert.setHeaderText("Are you sure?");
        confirmAlert.setContentText("Do you want to withdraw your application for " + application.getJobTitle() + "?");
